...
class AggregateArtistsSpark(luigi.contrib.spark.SparkSubmitTask):
    ...
    # the name of a jar file should be supplied instead.
    app = 'top_artists_spark.py'
    # Address of the Spark cluster master. In this case,
    # we are not using a cluster, but running Spark in local mode.
    master = 'local[*]'
    ...
    def app_options(self):
        # :func:`~luigi.task.Task.input`
        # returns the targets produced by the tasks in
