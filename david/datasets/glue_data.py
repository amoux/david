...
ORIGINAL AUTHOR CREDIT: This script for downloading data of the GLUE benchmark
was obtained from:
...
# This is a custom location added. If it doesnt exist in the users dirpath
# the it uses the default directory from the original source code.
GLUE_DIR = os.environ.get("GLUE_DIR")
if GLUE_DIR is None:
    GLUE_DIR = "glue_data"
...
def main(arguments):
    ...
    parser.add_argument(
        '--data_dir',
        help='directory to save data to. default: {}'.format(GLUE_DIR),
        type=str, default=GLUE_DIR,
    )
    parser.add_argument(
        '--tasks',
